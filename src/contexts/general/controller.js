...
const prepareProfile = (userFromDB) => {
  if (userFromDB.data) {
    let subscriptionDate; let userProduct; let
...
const getReply = async (message, params, userFromDB) => {
  ...
  let flowControlUpdate; let reply; let currency; let paymentUrl; let tempReply; let
    trueReply;
  ...
  switch (params.currentEntity) {
    ...
    case 'paymentDialog1':
      ...
      flowControlUpdate = {
        open_question: 'false', next_pos: 'TBD', prev_pos: 'paymentDialog1', current_flow: 'general',
      };
    ...
    case 'inboxMode':
      flowControlUpdate = {
        current_pos: 'inboxMode', prev_pos: 'inboxMode', open_question: 'false', current_flow: 'inboxMode',
      };
      try {
    ...
    case 'stopBotMessages':
      ...
      flowControlUpdate = {
        prev_pos: 'stopBotMessages', open_question: 'false', next_pos: 'fallback', current_flow: 'opentalk',
      };
    ...
    case 'helpUser1':
      flowControlUpdate = {
        current_pos: 'helpUser1', open_question: true, next_pos: 'helpUser_Final', current_flow: 'general',
      };
    ...
    case 'helpUser_Final':
      flowControlUpdate = {
        current_pos: 'helpUser_Final', open_question: 'false', next_pos: 'TBD', current_flow: params.prevFlow,
      };
    ...
    case 'sendRestartedContent':
      ...
      flowControlUpdate = {
        open_question: 'false', prev_pos: 'sendRestartedContent', next_pos: 'TBD', current_flow: 'opentalk',
      };
    ...
    case 'sendCustomUserRequest':
      flowControlUpdate = {
        open_question: 'false', next_pos: 'TBD', prev_pos: 'sendCustomUserRequest', current_flow: 'opentalk',
      };
    ...
    case 'confirmDeleteAccRequest':
      flowControlUpdate = {
        open_question: 'false', prev_pos: 'confirmDeleteAccRequest', next_pos: 'userDeleteAccSecondStep', current_flow: 'general',
      };
    ...
    case 'userDeleteAccSecondStep':
      flowControlUpdate = {
        open_question: 'false', prev_pos: 'userDeleteAccSecondStep', next_pos: 'accountDeletedMsg', current_flow: 'general',
      };
    ...
    case 'accountDeletedMsg':
      ...
      flowControlUpdate = {
        open_question: 'false', prev_pos: 'accountDeletedMsg', next_pos: 'fallback', current_flow: 'opentalk',
      };
