const getReply = async (message, params, userFromDB) => {
  ...
  if (userLevel === 1) {
    ...
    case 'badConnection':
        flowControlUpdate = { current_pos: 'badConnection', open_question: 'false', next_pos: 'TBD', prev_flow: 'tutor', repeated_this_pos: '0', tutor_flow_status: 'finished' }
    ...
    case 'goodConnection':
      flowControlUpdate = { current_pos: 'goodConnection', open_question: 'false', next_pos: 'TBD', prev_flow: 'tutor' }
    ...
    case 'maleTutor':
      flowControlUpdate = { current_pos: 'maleTutor', open_question: 'false', next_pos: 'openTalk', prev_flow: 'tutor', repeated_this_pos: '0', tutor_flow_status: 'finished' }
      reply = standardReplies('maleTutor', senderName)
      break

    case 'femaleTutor':
        flowControlUpdate = { current_pos: 'femaleTutor', open_question: 'false', next_pos: 'openTalk', prev_flow: 'tutor', repeated_this_pos: '0', tutor_flow_status: 'finished' }
      reply = standardReplies('femaleTutor', senderName)
      break

    case 'eitherTutor':
        flowControlUpdate = { current_pos: 'eitherTutor', open_question: 'false', next_pos: 'openTalk', prev_flow: 'tutor', repeated_this_pos: '0', tutor_flow_status: 'finished' }
      reply = standardReplies('eitherTutor', senderName)
      break

    case 'userCannotPay':
        flowControlUpdate = { current_pos: 'userCannotPay', open_question: 'false', next_pos: 'TBD', prev_flow: 'tutor', repeated_this_pos: '0', tutor_flow_status: 'finished' }
