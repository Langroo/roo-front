  ...
  if (userLevel === 1) {
     ...
     * ***************************************************************************************************** */
      case 'exploreTutorFlow':
        flowControlUpdate = {
          current_pos: 'exploreTutorFlow', prev_pos: 'exploreTutorFlow', open_question: 'false', next_pos: 'TBD', prev_flow: 'tutor',
        };
      ...
      case 'badConnection':
        flowControlUpdate = {
          current_pos: 'badConnection', prev_pos: 'badConnection', open_question: 'false', next_pos: 'TBD', prev_flow: 'opentalk',
        };
      ...
      case 'goodConnection':
        flowControlUpdate = {
          current_pos: 'goodConnection', prev_pos: 'goodConnection', open_question: 'false', next_pos: 'TBD', prev_flow: 'tutor',
        };
      ...
      case 'maleTutor':
        flowControlUpdate = {
          current_pos: 'maleTutor', prev_pos: 'maleTutor', open_question: 'false', next_pos: 'TDB', repeated_this_pos: '0', prev_flow: 'tutor',
        };
      ...
      case 'femaleTutor':
        flowControlUpdate = {
          current_pos: 'femaleTutor', prev_pos: 'femaleTutor', open_question: 'false', repeated_this_pos: '0', next_pos: 'TBD', prev_flow: 'tutor',
        };
      ...
      case 'eitherTutor':
        flowControlUpdate = {
          current_pos: 'eitherTutor', prev_pos: 'eitherTutor', open_question: 'false', next_pos: 'eitherTutor', repeated_this_pos: '0', prev_flow: 'tutor',
        };
      ...
      case 'userCannotPay':
        flowControlUpdate = {
          current_pos: 'userCannotPay', prev_pos: 'userCannotPay', open_question: 'false', next_pos: 'TBD', prev_flow: 'opentalk', repeated_this_pos: '0', tutor_flow_status: 'finished',
        };
      ...
      case 'userCanPay':
        flowControlUpdate = {
          current_pos: 'userCanPay', open_question: 'false', next_pos: 'TBD', prev_flow: 'opentalk', current_flow: 'opentalk',
        };
      ...
      case 'confirmWhenToCallTutor':
        ...
        flowControlUpdate = {
          current_pos: 'confirmWhenToCallTutor', prev_pos: 'confirmWhenToCallTutor', open_question: 'false', next_pos: 'TBD', prev_flow: 'tutor', current_flow: 'tutor', repeated_this_pos: '0',
        };
        futureMsgFlowUpdate = flowControlUpdate;
      ...
      case 'whenToCallTutor2':
        ...
        flowControlUpdate = {
          current_pos: 'whenToCallTutor2', prev_pos: 'confirmWhenToCallTutor', open_question: 'false', next_pos: 'TBD', prev_flow: 'tutor', current_flow: 'tutor', repeated_this_pos: '0',
        };
        futureMsgFlowUpdate = flowControlUpdate;
        futureRepliesToSend = standardReplies('askUserToContinue', senderName);
        break;
      ...
      case 'internetSpeedDescription':
        ...
        flowControlUpdate = {
          current_pos: 'internetSpeedDescription', prev_pos: 'internetSpeedDescription', open_question: 'false', next_pos: 'TBD', prev_flow: 'tutor', current_flow: 'tutor', repeated_this_pos: '0',
        };
        futureMsgFlowUpdate = flowControlUpdate;
        futureRepliesToSend = standardReplies('askUserToContinue', senderName);
        await BotCache.saveUserDataCache(message.sender.id, message.userHash, params.currentFlow, params.prevPos, params.rawUserInput);
      ...
      case 'knowThePrice':
        ...
        flowControlUpdate = {
          current_pos: 'knowThePrice', prev_pos: 'knowThePrice', open_question: 'false', next_pos: 'TBD', prev_flow: 'tutor', current_flow: 'tutor', repeated_this_pos: '0',
        };
        futureMsgFlowUpdate = flowControlUpdate;
        futureRepliesToSend = standardReplies('askUserToContinue', senderName);
        await BotCache.saveUserDataCache(message.sender.id, message.userHash, params.currentFlow, params.prevPos, params.rawUserInput);
      ...
      case 'userCanPayForTutor':
        ...
        flowControlUpdate = {
          current_pos: 'userCanPayForTutor', open_question: true, next_pos: 'fallback', prev_flow: 'opentalk', current_flow: 'opentalk', repeated_this_pos: '0', tutor_flow_status: 'finished',
        };
        try {
          axios.request({
      ...
      case 'userHasNoMoney':
        ...
        flowControlUpdate = {
          current_pos: 'userHasNoMoney', open_question: true, next_pos: 'tutorFlowFinished', prev_flow: 'opentalk', current_flow: 'opentalk', tutor_flow_status: 'finished',
        };
      ...
      case 'willDoTutorLater':
        ...
        if (params.prevFlow === 'introduction') {
          ...
          flowControlUpdate = {
            current_pos: 'fallback', open_question: true, next_pos: 'fallback', current_flow: 'opentalk', prev_flow: 'opentalk',
          };
