const getReply = async (message, params, userFromDB) => {
  ...
  if (params.currentEntity === undefined && params.OpQ) {
    ...
    DelayedUpdate = { current_pos: params.prevPos, open_question: 'false', prev_pos: params.prevPos, next_pos: params.nextPos, prev_flow: 'survey', repeated_this_pos: '1' }
  ...
  case 'surveyQuestion1':
    ...
    FlowUpdate = { current_pos: 'surveyQuestion1', open_question: 'false', prev_pos: 'surveyQuestion1', next_pos: 'surveyQuestion2', prev_flow: 'survey' }
    break
  ...
  case 'otherProblemLearning':
    ...
    FlowUpdate = { current_pos: 'otherProblemLearning', open_question: true, prev_pos: 'otherProblemLearning', next_pos: 'surveyQuestion3', survey_done: params.currentEntity }
    reminderToContinueOn = true
    break
  ...
  case 'otherMostImportant':
    ...
    FlowUpdate = { current_pos: 'otherMostImportant', open_question: true, prev_pos: 'otherMostImportant', next_pos: 'surveyQuestion8', survey_done: params.currentEntity }
    reminderToContinueOn = true
    break
  ...
  if (reminderToContinueOn) {
    ...
    if (params.currentEntity) {
      flowUpdateReminderMsg = { current_pos: params.currentEntity, open_question: true, next_pos: 'reliefOfUserContinuing', prev_flow: 'survey' }
    } else {
      flowUpdateReminderMsg = { current_pos: params.prevPos, open_question: true, next_pos: 'reliefOfUserContinuing', prev_flow: 'survey' }
    }
    ...
    controllerSmash.CronReminder(params.currentEntity, reminderReplies, waitingTime, flowUpdateReminderMsg, message.senderId, userFromDB)
  }

  if (willSendDelayedReply) {
    controllerSmash.CronReminder(params.currentEntity, delayedReplies, delayTime, DelayedUpdate, message.senderId, userFromDB)
  }
