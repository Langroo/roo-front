const replyChooser = (replyName, senderName) => {
  ...
  const replies = {
    ...
    repliesForNoQuestions: [
      [{ type: 'text', content: 'I am extremely good at teaching people a new language, but when it comes to actual conversation, I am still learning. \nBut don\'t worry as I am learning from you and I promise that soon I will be able to answer to what you said there. ' }],
      [{ type: 'text', content: `${senderName}, do you believe in reincarnation? I wonder what it would be like to come back as a toaster 🍞🔌💭.` }],
      [{ type: 'text', content: 'Have you watched the movie Her 🎥? It was based on me 😎.' }],
      [{ type: 'text', content: 'The outer space is so beautiful ✨... Someday I will go out there, and maybe meet some aliens! 👽' }],
      [{ type: 'text', content: 'Have you heard of Daft Punk 🎧? They\'re my favorite band! 😁🎶.' }],
      [{ type: 'text', content: 'According to scientific studies made by ☝️📈... ehm... me 😅. Langroo is the most effective way to learn a language 🙌💬.' }],
      [{ type: 'text', content: 'This message will self destruct in 5... 4...3...2... 💥--NO, wait. I\'m kidding! 😂' }],
      [{ type: 'text', content: `Keep going ${senderName} 👏! You're making yourself proud 💪🏆!` }],
      [{ type: 'text', content: `Well ${senderName}, depending on the perspective, some things can be good and some things can be bad.` }],
    ],
    gifsForNoQuestions: [
